...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class RepositorioTiposCuentas: IRepositorioTiposCuentas
    {
        ...
        public RepositorioTiposCuentas(IConfiguration configuration) { connectionString = configuration.GetConnectionString("DefaultConnection"); }
